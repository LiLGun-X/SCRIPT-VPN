...
echo -e "\033[1;33m]\033[1;37m -\033[1;32m OKAY !\033[1;37m"
tput cnorm
}
...
clear
echo -e "\E[44;1;37m              INSTALLER SQUID                \E[0m"
echo ""
...
echo -e "\n\033[1;33mWHICH PORTS DO YOU WANT TO USE ON THE SQUID \033[1;31m?"
echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mDEFINE THE DOORS IN SEQUENCE \033[1;33mEX: \033[1;37m8000 3128 8080"
echo ""
echo -ne "\033[1;32mINFORME AS PORTS\033[1;37m: "; read portass
if [[ -z "$portass" ]]; then
	echo -e "\n\033[1;31mPort disable!"
	sleep 3
	fun_conexao
fi
...
echo -e "
#Nome squid
visible_hostname PHCN-VPN-BY-PECH_CHHEAN
via off
forwarded_for off
...
echo -e "\n\033[1;32mCONFIRM SQUID PROXY\033[0m"
echo ""
fun_bar 'sqd_conf'
...
addpt_sqd () {
	...
	echo -e "\n\033[1;33mPORT IN USE: \033[1;32m$sqdp\n"
	...
	echo -e "\n\033[1;32mSUCCESSFULLY ADD PORT!"
	sleep 3
	clear
	fun_squid
}
...
fun_drop () {
	if netstat -nltp|grep 'dropbear' 1>/dev/null 2>/dev/null;then
		...
		echo -e "\E[44;1;37m              MANAGE DROBPEAR               \E[0m"
		echo -e "\n\033[1;33mPORTS\033[1;37m: \033[1;32m$dpbr"
		echo ""
		echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mLIMIT DROBPEAR $stats\033[0m"
		echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mALTERAR PORT DROPBEAR\033[0m"
		echo -e "\033[1;31m[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mREMOVE DROBPEAR\033[0m"
		...
		if [[ "$resposta" = 's' ]]; then
			echo -e "\n\033[1;33mDEFINE A DOOR FOR DROPBEAR !\033[0m\n"
			echo -ne "\033[1;32mWHICH PORT \033[1;33m?\033[1;37m "; read porta
			if [[ -z "$porta" ]]; then
				echo -e "\n\033[1;31mINVALID PORT!"
				sleep 3
				clear
...
if netstat -nltp|grep 'stunnel4' 1>/dev/null 2>/dev/null;then
    ...
    echo ""
    echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mCHANGE SSL PORT TUNNEL\033[0m"
	...
	if [[ -z "$porta" ]]; then
		echo ""
		echo -e "\033[1;31mPORT INCORRECT!"
		sleep 3
		clear
		fun_conexao		
	fi
	...
	echo ""
	netstat -nltp|grep 'stunnel4' > /dev/null && echo -e "\033[1;32mPORT ALTERADA COM SUCESSO !" || echo -e "\033[1;31mERRO INESPERADO!"
	sleep 3.5s
	clear
	fun_conexao
	fi
	...
	echo ""
	read -p "$(echo -e "\033[1;32mQUAL PORT DESEJA UTILIZAR? \033[1;37m")" -e -i 3128 porta
	if [[ -z "$porta" ]]; then
		echo ""
		echo -e "\033[1;31mPORT INCORRECT!"
		sleep 3
    ...
    echo -e "\n\033[1;32mSSL TUNNEL INSTALADO COM SUCESSO !\033[1;31m PORT: \033[1;33m$porta\033[0m"
    sleep 3
    clear
    fun_conexao
    else
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	do
		...
		case $option in
			...
			echo ""
			echo -ne "\033[1;32mQUAL PORT DESEJA UTILIZAR \033[1;33m?\033[1;37m "; read porta
			if [[ -z "$porta" ]]; then
				echo ""
				echo -e "\033[1;31mPORT INCORRECT!"
				sleep 3
		    ...
		    fun_bar 'fun_opn'
		    echo ""
		    echo -e "\033[1;32mPORT ALTERADA COM SUCESSO!\033[1;33m"
		    sleep 3
		    fun_conexao
			;;
			2) 
	...
	echo ""
	read -p "$(echo -e "\033[1;32mQUAL PORT DESEJA UTILIZAR? \033[1;37m")" -e -i 1194 porta
	if [[ -z "$porta" ]]; then
				echo ""
				echo -e "\033[1;31mPORT INCORRECT!"
				sleep 3
	...
	echo ""
	echo -e "\033[1;33mVERIFICANDO PORT..."
	sleep 2
	verif_ptrs $porta
	echo ""
...
fun_socks () {
	...
	if [[ "$resposta" = '1' ]]; then
		if ps x | grep proxy.py|grep -v grep 1>/dev/null 2>/dev/null; then
		    ...
		    echo ""
		    echo -ne "\033[1;32mQUAL PORT DESEJA ULTILIZAR \033[1;33m?\033[1;37m: "; read porta
		    if [[ -z "$porta" ]]; then
		    	echo ""
		    	echo -e "\033[1;31mPORT INCORRECT!"
		    	sleep 3
		...
		if ps x | grep proxy.py|grep -v grep 1>/dev/null 2>/dev/null; then
			...
			verif_ptrs $porta
			echo ""
			echo -e "\033[1;32mINICIANDO O PROXY SOCKS NA PORT \033[1;31m$porta\033[1;33m"
			echo ""
			abrirptsks () {
				sleep 1
				screen -dmS proxy python /etc/SSHPlus/proxy.py $porta
...
fun_openssh () {
	...
	echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mADICIONAR PORT\033[1;31m
...
[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mVOLTAR\033[0m"
	...
	if [[ "$resp" = '1' ]]; then
		clear
		echo -e "\E[44;1;37m         ADICIONAR PORT AO SSH         \E[0m\n"
		echo -ne "\033[1;32mQUAL PORT DESEJA ADICIONAR \033[1;33m?\033[1;37m "; read pt
		if [[ -z "$pt" ]]; then
			echo -e "\n\033[1;31mPORT INCORRECT!"
			sleep 3
			fun_conexao
		...
		verif_ptrs $pt
		echo -e "\n\033[1;32mADICIONANDO PORT AO SSH\033[0m"
		echo ""
		fun_addpssh () {
		...
		fun_bar 'fun_addpssh'
		echo -e "\n\033[1;32mPORT ADICIONADA COM SUCESSO\033[0m"
		sleep 3
		fun_conexao
	elif [[ "$resp" = '2' ]]; then
		clear
		echo -e "\E[41;1;37m         REMOVER PORT DO SSH         \E[0m"
		...
		echo -ne "\033[1;32mQUAL PORT DESEJA REMOVER \033[1;33m?\033[1;37m "; read pt
		if [[ -z "$pt" ]]; then
			echo -e "\n\033[1;31mPORT INCORRECT!"
			sleep 3
			fun_conexao
		...
		[[ $(grep -wc "$pt" '/etc/ssh/sshd_config') != '0' ]] && {
			echo -e "\n\033[1;32mREMOVENDO PORT DO SSH\033[0m"
			echo ""
			fun_delpssh () {
...
fun_sslh () {
 [[ "$(netstat -nltp|grep 'sslh' |wc -l)" = '0' ]] && {
	...
	echo -ne "\033[1;32mREALLY DESEJA REMOVER O SSLH  \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read respo
    if [[ "$respo" = "s" ]]; then
	    fun_delsslh () {
