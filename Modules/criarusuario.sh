      ...
      then
        ...
        then
          ...
          exit 1
           ...
           echo -ne "\033[1;32m● Password:\033[1;37m "; read password
          if [[ -z $password ]]
          then
            ...
            then
              ...
              exit 1
                ...
                echo -ne "\033[1;32m● Expiration Date:\033[1;37m "; read dias
                ...
                then
                  ...
                  then
                    ...
                    exit 1
                      ...
                      echo -ne "\033[1;32m● Connection Limited:\033[1;37m "; read sshlimiter
                              ...
                              if [[ "$resp" = @(s|S) ]]; then
                                ...
                                if [ -d /var/www/html/openvpn ]; then
                                  ...
                                  if [[ "$VERSION_ID" = 'VERSION_ID="14.04"' ]]; then
                                    echo -e "\033[1;32m● LINK\033[1;37m: \033[1;36m$IP:81/html/openvpn/$username.zip"
                                  else
                                    echo -e "\033[1;32m● LINK\033[1;37m: \033[1;36m$IP:81/openvpn/$username.zip"
                                  fi
                                else
                                ...
                                clear
                                echo -e "\E[44;1;37m       SSH ACCOUNT CREATED !      \E[0m"
                                [ $? -eq 0 ] && tput setaf 2 ; tput bold ; echo ""; echo -e "\033[1;32m✡ IP ADDRESS: \033[1;37m$IP" ; echo -e "\033[1;32m✡ USERNAME: \033[1;37m$username" ; echo -e "\033[1;32m✡ PASSWORD: \033[1;37m$password" ; echo -e "\033[1;32m✡ Expires in: \033[1;37m$gui" ; echo -e "\033[1;32m✡ LIMIT OF CONNECTIONS: \033[1;37m$sshlimiter" ; echo "" || echo "UNABLE TO CREATE USER!" ; tput sgr0
                              fi
                          else
                            clear
                            echo -e "\E[44;1;37m       SSH ACCOUNT CREATED !      \E[0m"
                            [ $? -eq 0 ] && tput setaf 2 ; tput bold ; echo ""; echo -e "\033[1;32mIP ADDRESS: \033[1;37m$IP" ; echo -e "\033[1;32m✡ USERNAME: \033[1;37m$username" ; echo -e "\033[1;32m✡ PASSWORD: \033[1;37m$password" ; echo -e "\033[1;32m✡ Eexpires in: \033[1;37m$gui" ; echo -e "\033[1;32m✡ LIMIT OF CONNECTIONS: \033[1;37m$sshlimiter" ; echo "" || echo "UNABLE TO CREATE USER!" ; tput sgr0
                          fi
                        fi
                      fi
                    fi
